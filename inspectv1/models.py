...
class Sites(models.Model):
    ...
    subsidiary = models.ForeignKey(
        "Subsidiary", on_delete=models.CASCADE,  default=3)
    ...
    stoffice = models.ForeignKey(
        "stoffice", on_delete=models.CASCADE,  default=3)
...
class InspectionMaster(models.Model):
    ...
    add_date = models.DateField("Add Date", auto_now_add=True,db_index=True)
...
class InspectItem(models.Model):
    inspector_name = models.CharField(
        "Inspector Name", max_length=100, default=' ')
    category_name = models.CharField(
        "Category Name", max_length=100, default=' ')
